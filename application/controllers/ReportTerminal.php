        ...
        <div class="d-flex col-12">
            <div class="col-12">
                ...
                <ul class="nav nav-tabs nav-justified" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" ng-style="tab==3 && selectedTab" href="#" role="tab" ng-click="setTab(3)">Transaction Details</a>
                    </li>
                </ul>
                <!-- Tab panels -->
                    ...
                    <div ng-show="isSet(2)">
                        <div id="my-tab-2">
                            ...
                            <div class="d-flex justify-content-center mb-1">
                                <div class="col-2" ><input type="date" class="form-control" ng-model="barcode_report_date" ng-change="changeDateFormat(start_date)"></div> To
                                <div class="col-2" ><input type="date" class="form-control" ng-model="barcode_report_end_date"></div>

                                <div class="col-2">
                                    <select class="form-control " ng-change="getAllBarcodeDetailsByDate(barcode_report_date,barcode_report_end_date,select_game.id,select_barcode_type.id,select_draw_time)"
                                ...
                                <div class="ml-2"><input type="button" class="btn btn-info form-control" value="Show" ng-click="getAllBarcodeDetailsByDate(barcode_report_date,barcode_report_end_date,select_barcode_type.id,select_draw_time)"></div>
                            </div>
...
<!-- starting 3rf tab -->
            ...
            <div ng-show="isSet(3)">
                        <div id="my-tab-3">
                            ...
                            <div class="d-flex justify-content-center mb-1">
                                <div class="col-2" ><input type="date" class="form-control" ng-model="transaction_start_date" ng-change="changeDateFormat(transaction_start_date)">
                                </div>

                                <div class="col-2" ><input type="date" class="form-control" ng-model="transaction_end_date" ng-change="changeDateFormat(transaction_end_date)">
                                </div>


                                <div class="ml-2"><input type="button" class="btn btn-info form-control" value="Show" ng-click="getTransactionReportOfTerminal(transaction_start_date,transaction_end_date)"></div>
                            </div>
                            ...
                            <div class="d-flex justify-content-between" ng-show="!isLoading2">
                                ...
                                <div class="col">
                                    ...
                                    <div class="d-flex justify-content-center" ng-show="transactionReportArray.length==0">
                                        <div>No records found</div>
                                    </div>
                                </div>
    ...
    public function get_2d_report_order_by_barcode(){
        $post_data =json_decode(file_get_contents("php://input"), true);
        $result=$this->Report_terminal_model->get_all_barcode_report_by_date($post_data['start_date'],$post_data['end_date'])->result_array();
        $report_array['records']=$result;
        echo json_encode($report_array,JSON_NUMERIC_CHECK);

    }

    public function get_terminal_transaction_report(){
        $post_data =json_decode(file_get_contents("php://input"), true);
        $result=$this->Report_terminal_model->get_terminal_transaction_report($post_data['start_date'],$post_data['end_date'])->result_array();
        $report_array['records']=$result;
        echo json_encode($report_array,JSON_NUMERIC_CHECK);
    ...
    public function get_game_full_details_report_game_wise(){
        $post_data =json_decode(file_get_contents("php://input"), true);
        $result=$this->Report_terminal_model->get_game_full_details_report($post_data['seriesId'],$post_data['drawDate'])->result_array();
        $report_array['records']=$result;
        echo json_encode($report_array,JSON_NUMERIC_CHECK);
