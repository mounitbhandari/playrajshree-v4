				      ...
				      <li class="nav-item dropdown">
				         ...
				         <li class="nav-item dropdown">
				            ...
				            <div class="dropdown-menu">
				                ...
				                <a class="dropdown-item" href="#!drawreport"></i>Drawwise Report</a>
				            </div>
				        </li>
				        ...
				        <li class="nav-item">
				         ...
				         <li class="nav-item">
				            <a class="nav-link" ng-href="#!message">Message</a>
				        </li>
						
						<li class="nav-item">
                        	<a class="nav-link" ng-href="#!addresult">Emergency</a>
                    	</li>
						...
						<li class="nav-item dropdown">
				            ...
				            <div class="dropdown-menu">
				                <a class="dropdown-item" href="#!helpTerminal"></i>Terminal</a>
				            </div>
				        </li>
